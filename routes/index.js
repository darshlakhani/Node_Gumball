		...
		if(hashnew==hash && count>0)
			{
				...
				var myCollection;
					...
					client.put("https://api.mongolab.com/api/1/databases/cmpe281/collections/Gumball?q={'model':'"+model+"'}&?apiKey=9yT5rUnhjouf05g-DkI0l6l3QnEfFU5F", args, function(data, response){
